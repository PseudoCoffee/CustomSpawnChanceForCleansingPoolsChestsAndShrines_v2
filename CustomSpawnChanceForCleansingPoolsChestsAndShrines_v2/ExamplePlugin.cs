...
{
    //This is an example plugin that can be put in BepInEx/plugins/CustomSpawnChanceForCleansingPoolsChestsAndShrines_v2/CustomSpawnChanceForCleansingPoolsChestsAndShrines_v2.dll to test out.
